          ...
          {contact.addresses.length ? (
            <div className="space-y-4">
              {contact.addresses.map((address) => (
                <div key={address.id} className="space-y-1.5">
                  <span className="inline-flex rounded-full border border-border bg-secondary px-2 py-0.5 text-[11px] font-semibold uppercase tracking-wide text-muted-foreground">
                    {address.type}
                  </span>
